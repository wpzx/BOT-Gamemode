...
// 📁 Lokasi file kredensial kamu (ubah sesuai nama file kamu)
...
try {
  ...
  console.error("[SHEETS] Gagal membaca file kredensial:", err.message);
  process.exit(1);
}
...
// ⚙️ Info spreadsheet (bisa ubah sesuai kebutuhan)
